                    ...
                    return Column(
                      children: [
                        ...
                        Expanded(
                          ...
                          ListTile(
                            title: Text(
                              'Se presenta información de motivos de asesoramiento en dispositivos de Asesorías en Salud Integral en Escuelas Secundarias (ASIE), que forman parte del Plan Enia. Cada asesoramiento permite el registro de más de un motivo, de esta forma la suma de estos puede superar al total de asesoramientos(1). El género autopercibido es registrado en el momento del asesoramiento (Ley de Identidad de Género N° 26.743) según lo manifestado por la persona adolescente. Se agrupan en la categoría “Otros géneros”: mujer trans, travesti y otros. Se excluyen los casos “Sin dato”.',
                          ...
                          ListTile(
                            ...
                            title: Text(
                                'La tarjeta “% por anticoncepción” muestra la proporción del motivo de asesoramiento “Anticoncepción” registrados como primer o segundo motivo sobre el total de asesoramientos en la  jurisdicción y el período seleccionados.'),
                            subtitle: Text(''),
                          ),
                          ListTile(
                            leading: Icon(Icons.arrow_drop_down_circle),
                            title: Text(
                                'La tarjeta “% de mujeres por anticoncepción” muestra la proporción de adolescentes autopercibidas mujeres cuyos motivos de asesoramiento fue “Anticoncepción”, registrados como primero o segundo motivo, sobre el total de asesoramientos realizados en la  jurisdicción y el período seleccionados.'),
                            subtitle: Text(''),
                          ),
                          ListTile(
                            leading: Icon(Icons.arrow_drop_down_circle),
                            title: Text(
                                'La tarjeta “% de varones por anticoncepción” muestra la proporción de adolescentes autopercibidos varones cuyos motivos de asesoramiento fue “Anticoncepción”, registrados como primero o segundo motivo, sobre el total de asesoramientos realizados en la  jurisdicción y el período seleccionados.'),
                            subtitle: Text(''),
                          ),
                          ListTile(
                            leading: Icon(Icons.arrow_drop_down_circle),
                            title: Text(
                                'La tarjeta “% de otres por anticoncepción” muestra la proporción de personas autopercibides de otros géneros cuyos motivos de asesoramiento fue “Anticoncepción”, registrados como primero o segundo motivo, sobre el total de asesoramientos realizados en la  jurisdicción y el período seleccionados.'),
                            subtitle: Text(''),
                          ),
                          ListTile(
                            title: Text(
                          ...
                          ListTile(
                            leading: Icon(Icons.arrow_drop_down_circle),
                            title: Text(
                                '“Principales motivos de asesoramientos”: Datos en valores absolutos. Se informan los 12 motivos de asesoramientos más frecuentes  en la  jurisdicción y el período seleccionados.'),
                            subtitle: Text(''),
                          ),
                          ListTile(
                            leading: Icon(Icons.arrow_drop_down_circle),
                            title: Text(
                                '“Principales motivos que requirieron pronta intervención”: Distribución porcentual de los principales motivos que demandan pronta intervención: abuso sexual, interrupción del embarazo, intento de suicidio, violencia de género y/o sexual en las relaciones familiares, otros tipos de violencias en las relaciones familiares; violencia de género y/o sexual entre pares, otros tipos de violencias entre pares; violencia de género y/o sexual en relaciones sexo-afectivas; otros tipos de violencias en otras relaciones. Datos de la jurisdicción y el período seleccionados.'),
                            subtitle: Text(''),
                          ),
                          ListTile(
                            leading: Icon(Icons.arrow_drop_down_circle),
