                    ...
                    return Column(
                      children: [
                        ...
                        Expanded(
                          ...
                          ListTile(
                            title: Text(
                              'Se presenta información de la cantidad de total de LARC1 dispensados e informados a Monitoreo del Plan Enia a población objetivo, y registrado por profesionales de la salud como dispensa post evento obstétrico (parto o aborto). La población objetivo del plan son personas con capacidad de gestar menores de 20 años de edad en departamentos priorizados por el Plan. Se informa en este tablero el total y por tipo (Implante subdérmico y DIU). Conjuntamente se presenta la cantidad de servicios de salud que informaron dispensa de LARC.',
                          ...
                          ListTile(
                            ...
                            title: Text(
                                'La tarjeta “Total dispensados” muestra la dispensa a población objetivo post evento obstétrico en la jurisdicción y el período seleccionados.'),
                            subtitle: Text(''),
                          ),
                          ListTile(
                            leading: Icon(Icons.arrow_drop_down_circle),
                            title: Text(
                                'La tarjeta “Subdérmicos” muestra la cantidad de este tipo de LARC dispensados a población objetivo post evento obstétrico en la jurisdicción y el período seleccionados.'),
                            subtitle: Text(''),
                          ),
                          ListTile(
                            leading: Icon(Icons.arrow_drop_down_circle),
                            title: Text(
                                'La tarjeta “DIU” muestra la cantidad de este tipo de LARC dispensados a población objetivo post evento obstétrico en la jurisdicción y el período seleccionados. Se considera el conteo total de DIU, DIU MULTILOAD y DIU_LNG –hormonal-).'),
                            subtitle: Text(''),
                          ),
                          ListTile(
                            leading: Icon(Icons.arrow_drop_down_circle),
                            title: Text(
                                'La tarjeta “Servicios de salud involucrados” cuenta la cantidad de servicios de salud que informaron esa dispensa post evento obstétrico en la jurisdicción y el período seleccionados.'),
                            subtitle: Text(''),
                          ),
                          ListTile(
                            title: Text(
                          ...
                          ListTile(
                            leading: Icon(Icons.arrow_drop_down_circle),
                            title: Text(
                                '“Dispensados por jurisdicción”: presenta en valores absolutos, la cantidad de LARC dispensados post evento obstétrico a población objetivo del Plan por jurisdicción en el período seleccionado.'),
                            subtitle: Text(''),
                          ),
                          ListTile(
                            leading: Icon(Icons.arrow_drop_down_circle),
                            title: Text(
                                '“Dispensados por tipo de servicio”: presenta en porcentaje la dispensa post evento obstétrico por tipo de efector (CAPS, Hospital, Otro – incluye servicios móviles, programas itinerantes, CIC, equipos territoriales y programas provinciales de SSR-).'),
                            subtitle: Text(''),
                          ),
                          ListTile(
                            leading: Icon(Icons.arrow_drop_down_circle),
                            title: Text(
                                '“Evolución mensual de la Dispensa”: presenta en valores absolutos la cantidad de LARC dispensados post evento obstétrico a población objetivo del Plan en la jurisdicción y el período seleccionados.'),
                            subtitle: Text(''),
                          ),
                          ListTile(
                            title: Text(
