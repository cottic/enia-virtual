                    ...
                    return Column(
                      children: [
                        ...
                        Expanded(
                          ...
                          ListTile(
                            title: Text(
                              'Contiene información de la cantidad de adolescentes asesoradas/es/os) destinatarias/es/os del Plan Enia en el Dispositivo de Base Comunitaria (DBC). Se definió contabilizar a adolescentes asesoradas/es/as como aquellas/es/os que recibieron al menos un asesoramiento (individual o grupal) en un año calendario. De esta forma la cantidad de adolescentes es menor o igual a la cantidad de asesoramientos brindados 1. ',
                          ...
                          ListTile(
                            ...
                            title: Text(
                                'La tarjeta “Adolescentes asesorades” muestra  la cantidad de adolescentes que recibieron al menos un asesoramiento en DBC en la jurisdicción y el período seleccionado.'),
                            subtitle: Text(''),
                          ),
                          ListTile(
                            leading: Icon(Icons.arrow_drop_down_circle),
                            title: Text(
                                'La tarjeta “% de cobertura de la matrícula” muestra la proporción de adolescentes que declaran estar escolarizados sobre el total de adolescentes asesoradas/es/os en DBC en la jurisdicción y el  período seleccionados.'),
                            subtitle: Text(''),
                          ),
                          ListTile(
                            leading: Icon(Icons.arrow_drop_down_circle),
                            title: Text(
                                'La tarjeta “% de individuales” muestra la proporción de adolescentes asesoradas/es/as en modalidad individual sobre el total de adolescentes asesoradas/es/os en la jurisdicción y el  período seleccionado.'),
                            subtitle: Text(''),
                          ),
                          ListTile(
                            leading: Icon(Icons.arrow_drop_down_circle),
                            title: Text(
                                'La tarjeta “% de grupales” muestra la proporción de adolescentes asesoradas/es/os en modalidad grupal (dos a cinco adolescentes) sobre el total de adolescentes asesoradas/es/os  en la jurisdicción y el  período seleccionado.'),
                            subtitle: Text(''),
                          ),
                          ListTile(
                            title: Text(
                          ...
                          ListTile(
                            leading: Icon(Icons.arrow_drop_down_circle),
                            title: Text(
                                '“Adolescentes por tipo de localización y jurisdicción”: Datos en valores absolutos. Se presenta la cantidad de adolescentes asesoradas/es/os según tipo de localización (escuelas, servicios de salud, espacios comunitarios) y modalidad virtual por jurisdicción en el período seleccionado. '),
                            subtitle: Text(''),
                          ),
                          ListTile(
                            leading: Icon(Icons.arrow_drop_down_circle),
                          ...
                          ListTile(
                            title: Text(
                                'Los tableros permiten seleccionar períodos de tiempo de un mes o mayores y también seleccionar jurisdicciones: total Enia, provincia o departamento. El inicio del reporte de asesoramientos individuales y grupales fue octubre de 2018. '),
                            subtitle: Text(''),
                          ),
                          ListTile(
                            title: Text(
