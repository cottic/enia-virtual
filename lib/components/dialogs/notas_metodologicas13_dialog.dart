                    ...
                    return Column(
                      children: [
                        ...
                        Expanded(
                          ...
                          ListTile(
                            title: Text(
                              'Se presenta información de las/es/os adolescentes asesoradas/es/os por género autopercibido, grupo etario y condición de escolarización en los dispositivos de Asesorías en Espacios Comunitarios (DBC), que forman parte del Plan Enia. Se contabiliza las/es/los adolescentes asesoradas/es/os como quienes recibieron al menos un asesoramiento (individual o grupal) en un año calendario. De esta forma la cantidad de adolescentes es menor o igual a la cantidad de asesoramientos brindados 1. El género autopercibido es registrado en el momento del asesoramiento (Ley de Identidad de Género N° 26.743) según lo manifestado por la/el/le adolescente. Se agrupan en la categoría “Otros géneros”: mujer trans, travesti y otros. Se excluyen los casos “Sin dato”.',
                          ...
                          ListTile(
                            ...
                            title: Text(
                                'La tarjeta “Mujeres” cuenta la cantidad de adolescentes autopercibidas mujeres que recibieron al menos un asesoramiento en DBC en la jurisdicción y el período seleccionados.'),
                            subtitle: Text(''),
                          ),
                          ListTile(
                            leading: Icon(Icons.arrow_drop_down_circle),
                            title: Text(
                                'La tarjeta “Varones” cuenta la cantidad de adolescentes autopercibidos varones que recibieron al menos un asesoramiento en DBC en la jurisdicción y el período seleccionados.'),
                            subtitle: Text(''),
                          ),
                          ListTile(
                            leading: Icon(Icons.arrow_drop_down_circle),
                            title: Text(
                                'La tarjeta “Varones Trans” cuenta la cantidad de adolescentes autopercibidos varones trans que recibieron al menos un asesoramiento en DBC en la jurisdicción y el período seleccionados.'),
                            subtitle: Text(''),
                          ),
                          ListTile(
                            leading: Icon(Icons.arrow_drop_down_circle),
                            title: Text(
                                'La tarjeta “Otros géneros” cuenta la cantidad de adolescentes autopercibidas/es/os en otros géneros distintos a los mencionados que recibieron al menos un asesoramiento en DBC en la jurisdicción y el período seleccionados.'),
                            subtitle: Text(''),
                          ),
                          ListTile(
                            title: Text(
                          ...
                          ListTile(
                            leading: Icon(Icons.arrow_drop_down_circle),
                            title: Text(
                                '“Adolescentes por género autopercibido y jurisdicción”: Datos en valores absolutos. Se presenta la cantidad de adolescentes asesoradas/es/os en DBC según género autopercibido (agrupado) y jurisdicción en el período seleccionado. '),
                            subtitle: Text(''),
                          ),
                          ListTile(
                            leading: Icon(Icons.arrow_drop_down_circle),
                            title: Text(
                                '“Adolescentes según grupo etario”: Distribución porcentual de adolescentes asesoradas/es/os en asesoramientos individuales y grupales en DBC según grupos de edad en la jurisdicción y el período seleccionados.'),
                            subtitle: Text(''),
                          ),
                          ListTile(
                            leading: Icon(Icons.arrow_drop_down_circle),
                            title: Text(
                                '“Evolución mensual de adolescentes asesoradas/es/os por género autopercibido”: Datos en valores absolutos. Se presenta la evolución mensual de adolescentes asesoradas/es/os en asesoramientos individuales y grupales en DBC según género autopercibido en la jurisdicción y el período seleccionados.'),
                            subtitle: Text(''),
                          ),
                          ListTile(
                            title: Text(
