...
import 'package:fluffychat/components/dialogs/notas_metodologicas07_dialog.dart';
...
class StatsEniaMenu07View extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return AdaptivePageLayout(
      primaryPage: FocusPage.SECOND,
      firstScaffold: DashboardMainMenu(),
      secondScaffold: StatsEniaMenu07(),
    );
  }
}

class StatsEniaMenu07 extends StatefulWidget {
  @override
  _StatsEniaMenu07State createState() => _StatsEniaMenu07State();
}

class _StatsEniaMenu07State extends State<StatsEniaMenu07> {
  Board board = Board();
  ...
  Future<Board> loadConfigJson() async {
    ...
    board = dashboard.boards[7];
    cardChart0 = dashboard.boards[7].charts[0];
    cardChart1 = dashboard.boards[7].charts[1];
    cardChart2 = dashboard.boards[7].charts[2];
    cardChart3 = dashboard.boards[7].charts[3];
    barChart = dashboard.boards[7].charts[4];
    pieSingleChart = dashboard.boards[7].charts[5];
    pieChart = dashboard.boards[7].charts[6];
    lineChart = dashboard.boards[7].charts[7];
