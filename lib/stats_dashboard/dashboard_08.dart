...
import 'package:fluffychat/components/dialogs/notas_metodologicas08_dialog.dart';
...
class StatsEniaMenu08View extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return AdaptivePageLayout(
      primaryPage: FocusPage.SECOND,
      firstScaffold: DashboardMainMenu(),
      secondScaffold: StatsEniaMenu08(),
    );
  }
}

class StatsEniaMenu08 extends StatefulWidget {
  @override
  _StatsEniaMenu08State createState() => _StatsEniaMenu08State();
}

class _StatsEniaMenu08State extends State<StatsEniaMenu08> {
  Board board = Board();
  ...
  Future<Board> loadConfigJson() async {
    ...
    board = dashboard.boards[8];
    cardChart0 = dashboard.boards[8].charts[0];
    cardChart1 = dashboard.boards[8].charts[1];
    cardChart2 = dashboard.boards[8].charts[2];
    cardChart3 = dashboard.boards[8].charts[3];
    barChart = dashboard.boards[8].charts[4];
    pieSingleChart = dashboard.boards[8].charts[5];
    pieChart = dashboard.boards[8].charts[6];
    lineChart = dashboard.boards[8].charts[7];
