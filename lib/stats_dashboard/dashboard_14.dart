...
import 'package:fluffychat/components/dialogs/notas_metodologicas14_dialog.dart';
...
class StatsEniaMenu14View extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return AdaptivePageLayout(
      primaryPage: FocusPage.SECOND,
      firstScaffold: DashboardMainMenu(),
      secondScaffold: StatsEniaMenu14(),
    );
  }
}

class StatsEniaMenu14 extends StatefulWidget {
  @override
  _StatsEniaMenu14State createState() => _StatsEniaMenu14State();
}

class _StatsEniaMenu14State extends State<StatsEniaMenu14> {
  Board board = Board();
  ...
  Future<Board> loadConfigJson() async {
    ...
    board = dashboard.boards[14];
    cardChart0 = dashboard.boards[14].charts[0];
    cardChart1 = dashboard.boards[14].charts[1];
    cardChart2 = dashboard.boards[14].charts[2];
    cardChart3 = dashboard.boards[14].charts[3];
    barChart = dashboard.boards[14].charts[4];
    pieSingleChart = dashboard.boards[14].charts[5];
    pieChart = dashboard.boards[14].charts[6];
    lineChart = dashboard.boards[14].charts[7];
