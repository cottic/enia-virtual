...
import 'package:fluffychat/components/dialogs/notas_metodologicas09_dialog.dart';
...
class StatsEniaMenu09View extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return AdaptivePageLayout(
      primaryPage: FocusPage.SECOND,
      firstScaffold: DashboardMainMenu(),
      secondScaffold: StatsEniaMenu09(),
    );
  }
}

class StatsEniaMenu09 extends StatefulWidget {
  @override
  _StatsEniaMenu09State createState() => _StatsEniaMenu09State();
}

class _StatsEniaMenu09State extends State<StatsEniaMenu09> {
  Board board = Board();
  ...
  Future<Board> loadConfigJson() async {
    ...
    board = dashboard.boards[9];
    cardChart0 = dashboard.boards[9].charts[0];
    cardChart1 = dashboard.boards[9].charts[1];
    cardChart2 = dashboard.boards[9].charts[2];
    cardChart3 = dashboard.boards[9].charts[3];
    barChart = dashboard.boards[9].charts[4];
    pieSingleChart = dashboard.boards[9].charts[5];
    pieChart = dashboard.boards[9].charts[6];
    lineChart = dashboard.boards[9].charts[7];
