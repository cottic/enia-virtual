...
import 'package:fluffychat/components/dialogs/notas_metodologicas13_dialog.dart';
...
class StatsEniaMenu13View extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return AdaptivePageLayout(
      primaryPage: FocusPage.SECOND,
      firstScaffold: DashboardMainMenu(),
      secondScaffold: StatsEniaMenu13(),
    );
  }
}

class StatsEniaMenu13 extends StatefulWidget {
  @override
  _StatsEniaMenu13State createState() => _StatsEniaMenu13State();
}

class _StatsEniaMenu13State extends State<StatsEniaMenu13> {
  Board board = Board();
  ...
  Future<Board> loadConfigJson() async {
    ...
    board = dashboard.boards[13];
    cardChart0 = dashboard.boards[13].charts[0];
    cardChart1 = dashboard.boards[13].charts[1];
    cardChart2 = dashboard.boards[13].charts[2];
    cardChart3 = dashboard.boards[13].charts[3];
    barChart = dashboard.boards[13].charts[4];
    pieSingleChart = dashboard.boards[13].charts[5];
    pieChart = dashboard.boards[13].charts[6];
    lineChart = dashboard.boards[13].charts[7];
