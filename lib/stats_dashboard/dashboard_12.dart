...
import 'package:fluffychat/components/dialogs/notas_metodologicas12_dialog.dart';
...
class StatsEniaMenu12View extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return AdaptivePageLayout(
      primaryPage: FocusPage.SECOND,
      firstScaffold: DashboardMainMenu(),
      secondScaffold: StatsEniaMenu12(),
    );
  }
}

class StatsEniaMenu12 extends StatefulWidget {
  @override
  _StatsEniaMenu12State createState() => _StatsEniaMenu12State();
}

class _StatsEniaMenu12State extends State<StatsEniaMenu12> {
  Board board = Board();
  ...
  Future<Board> loadConfigJson() async {
    ...
    board = dashboard.boards[12];
    cardChart0 = dashboard.boards[12].charts[0];
    cardChart1 = dashboard.boards[12].charts[1];
    cardChart2 = dashboard.boards[12].charts[2];
    cardChart3 = dashboard.boards[12].charts[3];
    barChart = dashboard.boards[12].charts[4];
    pieSingleChart = dashboard.boards[12].charts[5];
    pieChart = dashboard.boards[12].charts[6];
    lineChart = dashboard.boards[12].charts[7];
